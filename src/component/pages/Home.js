    ...
    return (
        <>
            ...
            <div className="absolute z-20 bottom-3 right-0 m-3 flex flex-col gap-5 ">
                ...
                <a  href="https://github.com/ankitchaudhry1259" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faGithub} className="nnn mx-2 text-xl hover_social  hover:text-[#009e66] relative " /></a>
                <a  href="https://www.linkedin.com/in/ankitchaudhry59/" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faLinkedinIn} className="nnn mx-2 text-xl hover_social  hover:text-[#009e66]" /></a>
